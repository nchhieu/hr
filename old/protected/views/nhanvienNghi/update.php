...
$this->breadcrumbs=array(
	...
	$model->nghi_id=>array('view','id'=>$model->nghi_id),
	'Update',
);
?> 
<div class="span12">
  <div class='row-fluid'>
    <div class='span12'>
      <div class='page-header'>
        <h1 class='pull-left'> <i class='icon-table'></i> <span> Update NhanvienNghi # <?php echo $model->nghi_id; ?> </span> </h1>
  ...
  <div class='row-fluid'>
    <div class='span12 box bordered-box blue-border' style='margin-bottom:0;'>
      <div class='box-header blue-background'>
        <div class='title'>Update NhanvienNghi # <?php echo $model->nghi_id; ?></div>
