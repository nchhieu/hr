...
class NhanvienGhichu extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('chude_id, nguoidung_id', 'numerical', 'integerOnly'=>true),
			array('nhanvien_id', 'length', 'max'=>9),
			array('ghichu_tieude', 'length', 'max'=>255),
			array('ghichu_noidung, ghichu_ngay', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ghichu_id, nhanvien_id, chude_id, ghichu_tieude, ghichu_noidung, ghichu_ngay, nguoidung_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'chude_id' => 'Chủ đề',
			'ghichu_tieude' => 'Tiêu đề',
			'ghichu_noidung' => 'Nội dung',
			'ghichu_ngay' => 'Ngày',
			'nguoidung_id' => 'Ngưòi dùng',
		);
	}
