...
<div class="view"> <b><?php echo CHtml::encode($data->getAttributeLabel('hopdong_id')); ?>:</b> <?php echo CHtml::link(CHtml::encode($data->hopdong_id), array('view', 'id'=>$data->hopdong_id)); ?> <br />
  <b><?php echo CHtml::encode($data->getAttributeLabel('nhanvien_id')); ?>:</b> <?php echo CHtml::encode($data->nhanvien_id); ?> <br />
  <b><?php echo CHtml::encode($data->getAttributeLabel('bophan_id')); ?>:</b> <?php echo CHtml::encode($data->bophan_id); ?> <br />
  <b><?php echo CHtml::encode($data->getAttributeLabel('chucdanh_id')); ?>:</b> <?php echo CHtml::encode($data->chucdanh_id); ?> <br />
  <b><?php echo CHtml::encode($data->getAttributeLabel('hopdong_ma')); ?>:</b> <?php echo CHtml::encode($data->hopdong_ma); ?> <br />
  <b><?php echo CHtml::encode($data->getAttributeLabel('hopdong_ngaybatdau')); ?>:</b> <?php echo CHtml::encode($data->hopdong_ngaybatdau); ?> <br />
  <b><?php echo CHtml::encode($data->getAttributeLabel('hopdong_ngayketthuc')); ?>:</b> <?php echo CHtml::encode($data->hopdong_ngayketthuc); ?> <br />
  <?php /*
