...
<fieldset>
  ...
  <div class="form-group"> <?php echo $form->labelEx($model,'admin_password',array('class'=>'col-sm-4 col-lg-3 control-label')); ?>
    <div class="col-sm-8 col-lg-9 controls"> <?php echo $form->textField($model,'admin_password',array('size'=>60,'maxlength'=>125,'class'=>'form-control  show-tooltip','data-original-title'=>'Chỉ nhập mật khẩu khi bạn muốn đổi mật khẩu','data-placement'=>'top')); ?> <span class="help-inline">Chỉ nhập mật khẩu khi bạn muốn đổi mật khẩu </span> <?php echo $form->error($model,'admin_password'); ?> </div>
  </div>
  ...
  <div class="form-group"> <?php echo $form->labelEx($model,'admin_avatar',array('class'=>'col-sm-4 col-lg-3 control-label')); ?>
    <div class="col-sm-8 col-lg-9 controls">
      <div class="fileupload fileupload-new" data-provides="fileupload">
        ...
        <?php echo $form->error($model,'admin_avatar'); ?>
      </div>
    </div>
  </div>
  
  <div class="form-group"> <?php echo $form->labelEx($model,'admin_default_url',array('class'=>'col-sm-4 col-lg-3 control-label')); ?>
    <div class="col-sm-8 col-lg-9 controls"> <?php echo $form->textField($model,'admin_default_url',array('maxlength'=>255,'class'=>'form-control')); ?> <?php echo $form->error($model,'admin_default_url'); ?> </div>
  </div>
  <div class="form-group"> <?php echo $form->labelEx($model,'admin_group',array('class'=>'col-sm-4 col-lg-3 control-label')); ?>
    <div class="col-sm-8 col-lg-9 controls"> <?php echo $form->dropDownList($model,'admin_group',array('Admin'=>'Admin','User'=>'User'), array('class'=>'form-control')); ?> <?php echo $form->error($model,'admin_group'); ?> </div>
  </div>
   <div class="form-group"> <?php echo $form->labelEx($model,'admin_rights',array('class'=>'col-sm-4 col-lg-3 control-label')); ?>
    <div class="col-sm-8 col-lg-9 controls"> <?php echo $form->textField($model,'admin_rights',array('size'=>16,'maxlength'=>16,'class'=>'form-control')); ?> <?php echo $form->error($model,'admin_rights'); ?> </div>
  </div>
