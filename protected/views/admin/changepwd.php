...
<div class="page-title">
  <div>
    <h2> <i class="fa fa-desktop"></i> <i class='icon-table'></i> <span> Quản trị # <?php echo $model->admin_id; ?> </h2>
    <h4></h4>
  </div>
  <div id="breadcrumbs">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        <div class="box-title">
          <h3><i class="fa fa-bars"></i> Đổi mật khẩu # <?php echo $model->admin_id; ?></h3>
