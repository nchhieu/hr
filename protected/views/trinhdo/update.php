...
$this->breadcrumbs=array(
	...
	$model->trinhdo_id=>array('view','id'=>$model->trinhdo_id),
	'Cập nhật',
);
?> 
<div class="page-title">
  <div>
    <h2> <i class="fa fa-desktop"></i> Cập nhật trình độ: <?php echo $model->trinhdo_ten; ?> </h2>
    <h4></h4>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        <div class="box-title">
          <h3><i class="fa fa-bars"></i>  Cập nhật Trinhdo # <?php echo $model->trinhdo_id; ?></h3>
